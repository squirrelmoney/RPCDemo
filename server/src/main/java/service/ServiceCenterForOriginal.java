 ...
 **/
public class ServiceCenterForOriginal implements server {
    ...
    public ServiceCenterForOriginal(int port) {
        ServiceCenterForOriginal.port = port;
    }
    ...
    private static class ServiceTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("原生序列化: " + (System.currentTimeMillis() - t2) + "ms; "+"大小："+out.toByteArray().length);
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                if (output != null) {
